...
! --------------------------------------------------------------------
       ...
       tcel,vppa,psychr,xlhv,GRID_SOIL%zdeep,GRID_SOIL%Tdeepstep,GRID_MET%rsd,GRID_MET%rld,toleb,maxnri,GLOBAL%dt,i,tkel,&
...
! --------------------------------------------------------------------
       ...
       GRID_MET%rsd,r_lup,GRID_MET%rld,toleb,maxnri,GLOBAL%dt,i,GRID_VEG%albd,r_sdn,GRID_VARS%rnetpn,&
