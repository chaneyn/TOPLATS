...
! --------------------------------------------------------------------
       ...
       GRID_VEG%rescan,inc_frozen,GRID_VEG%ivgtyp,rzsm,rzsm_u,GRID_VEG%tc,GRID_VEG%tw,smcond,tzsm,tzsm_u,&
       ...
       GRID_VEG%respla,xkrz,ztz,stzrel,xkstz,xktz,Swq,GRID_VARS%evtact,GRID_VARS%ievcon,Swq_us,evtact_us,&
