...
! --------------------------------------------------------------------
  ...
  call set_unit_name (i_str//': '//i_str//': '//'lswb.f90: rnsum')
  call assert_equals (REG_OLD%rnsum,REG_NEW%rnsum)
  call set_unit_name (i_str//': '//'lswb.f90: xlesum')
  call assert_equals (REG_OLD%xlesum,REG_NEW%xlesum)
  call set_unit_name (i_str//': '//'lswb.f90: hsum')
  call assert_equals (REG_OLD%hsum,REG_NEW%hsum)
  call set_unit_name (i_str//': '//'lswb.f90: gsum')
  call assert_equals (REG_OLD%gsum,REG_NEW%gsum)
  call set_unit_name (i_str//': '//'lswb.f90: tksum')
  call assert_equals (REG_OLD%tksum,REG_NEW%tksum)
  call set_unit_name (i_str//': '//'lswb.f90: tkmidsum')
  call assert_equals (REG_OLD%tkmidsum,REG_NEW%tkmidsum)
  call set_unit_name (i_str//': '//'lswb.f90: tkdeepsum')
...
! --------------------------------------------------------------------
  ...
  call set_unit_name (i_str//': '//'lswb.f90: wcip1sum')
  call assert_equals (REG_OLD%wcip1sum,REG_NEW%wcip1sum)
  call set_unit_name (i_str//': '//'lswb.f90: wcsum')
  call assert_equals (nint(REG_OLD%wcsum),nint(REG_NEW%wcsum))
  call set_unit_name (i_str//': '//'lswb.f90: dswcsum')
  call assert_equals (REG_OLD%dswcsum,REG_NEW%dswcsum)
  call set_unit_name (i_str//': '//'lswb.f90: wcrhssum')
...
! --------------------------------------------------------------------
  ...
  call set_unit_name (i_str//': '//'lswb.f90: ettotrg')
  call assert_equals (REG_OLD%ettotrg,REG_NEW%ettotrg)
  call set_unit_name (i_str//': '//'lswb.f90: persac')
  call assert_equals (REG_OLD%persac,REG_NEW%persac)
  call set_unit_name (i_str//': '//'lswb.f90: peruac')
  call assert_equals (REG_OLD%peruac,REG_NEW%peruac)
  call set_unit_name (i_str//': '//'lswb.f90: perusc')
  call assert_equals (REG_OLD%perusc,REG_NEW%perusc)
  call set_unit_name (i_str//': '//'lswb.f90: pnetsumrg')
  call assert_equals (REG_OLD%pnetsumrg,REG_NEW%pnetsumrg)
  call set_unit_name (i_str//': '//'lswb.f90: persxr')
  call assert_equals (REG_OLD%persxr,REG_NEW%persxr)
  call set_unit_name (i_str//': '//'lswb.f90: perixr')
...
! --------------------------------------------------------------------
  ...
  call set_unit_name (i_str//': '//'lswb.f90: Swq_ussum')
  call assert_equals (REG_OLD%Swq_ussum,REG_NEW%Swq_ussum)
  call set_unit_name (i_str//': '//'lswb.f90: Swqsum')
  call assert_equals (REG_OLD%Swqsum,REG_NEW%Swqsum)
  call set_unit_name (i_str//': '//'lswb.f90: Sdepth_ussum')
  call assert_equals (REG_OLD%Sdepth_ussum,REG_NEW%Sdepth_ussum)
  call set_unit_name (i_str//': '//'lswb.f90: Sdepthsum')
